...
class TrackingCase extends CI_Model {
    ...
    private $caseLibrary = array(
        ...
        'odbiór własny' => array('hierarchy' => '5', 'description' => 'Changed to Personal Pickup', 'overallStatus' => 'Delivered', 'address' => 'Dane klienta (CSV), API(Panstwo) lub Bedford MK42, GB - gdy zwrot'),
        'odbór własny' => array('hierarchy' => '5', 'description' => 'Changed to Personal Pickup', 'overallStatus' => 'Delivered', 'address' => 'Dane klienta (CSV), API(Panstwo) lub "Bedford MK42, GB - gdy zwrot'),
        ...
        'umówiono odbiór własny' => array('hierarchy' => '4', 'description' => 'Recipient changed delivery date', 'overallStatus' => 'At parcel delivery centre', 'address' => 'Dane klienta (CSV), API(Panstwo)'),
        'przesyłka niedoręczona - rezygnacja klienta z przesyłki' => array('hierarchy' => '4', 'description' => 'Undelivered - Recipient rejected the delivery', 'overallStatus' => 'At parcel delivery centre', 'address' => 'Dane klienta (CSV), API(Panstwo)'),
