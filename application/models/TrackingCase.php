...
class TrackingCase extends CI_Model {
    ...
    private $caseLibrary = array(
        ...
        'odbiór własny' => array('hierarchy' => '4', 'description' => 'Delivered', 'overallStatus' => 'Delivered', 'address' => 'Dane klienta (CSV), API(Panstwo) lub Bedford MK42, GB - gdy zwrot'),
        'odbór własny' => array('hierarchy' => '4', 'description' => 'Delivered', 'overallStatus' => 'Delivered', 'address' => 'Dane klienta (CSV), API(Panstwo) lub "Bedford MK42, GB - gdy zwrot'),
